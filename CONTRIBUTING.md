...
If you find a bug in the source code, you can help us by [submitting an issue](https://github.com/terraform-docs/git-chglog/issues) to our [GitHub Repository](https://github.com/terraform-docs/git-chglog). Even better, you can submit a Pull Request with a fix.
