...
func TestGeneratorNotFoundTags(t *testing.T) {
	...
	gen := NewGenerator(&Config{
		...
		Info: &Info{
			RepositoryURL: "https://github.com/terraform-docs/git-chglog",
		},
		Options: &Options{},
	})
...
[Unreleased]: https://github.com/terraform-docs/git-chglog/compare/2.0.0-beta.0...HEAD
[2.0.0-beta.0]: https://github.com/terraform-docs/git-chglog/compare/1.1.0...2.0.0-beta.0
[1.1.0]: https://github.com/terraform-docs/git-chglog/compare/1.0.0...1.1.0`, output)
}
...
[Unreleased]: https://github.com/terraform-docs/git-chglog/compare/3.0.0...HEAD
[3.0.0]: https://github.com/terraform-docs/git-chglog/compare/2.0.0...3.0.0
[2.0.0]: https://github.com/terraform-docs/git-chglog/compare/1.0.0...2.0.0`, output)
...
[Unreleased]: https://github.com/terraform-docs/git-chglog/compare/3.0.0...HEAD
[3.0.0]: https://github.com/terraform-docs/git-chglog/compare/2.0.0...3.0.0`, output)
}
...
[Unreleased]: https://github.com/terraform-docs/git-chglog/compare/v1.0.0...HEAD`, strings.TrimSpace(buf.String()))
